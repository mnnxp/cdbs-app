...
Solutions for integration with CADBase platform with our support:
 ...
 - CADBase Library workbench for interaction with the platform via CAD program FreeCAD ([GitHub](https://github.com/mnnxp/cadbaselibrary-freecad/), [GitLab](https://gitlab.com/cadbase/cadbaselibrary-freecad/), [Codeberg](https://codeberg.org/mnnxp/cadbaselibrary-freecad/))
 - CADBase Library add-on for interaction with the platform through the 3D computer graphics program Blender ([GitLab](https://gitlab.com/cadbase/cadbaselibrary-blender/), [Blender Extensions](https://extensions.blender.org/add-ons/cadbase-library/))
