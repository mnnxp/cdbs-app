...
lazy_static! {
    ...
    pub(super) static ref LOCAL_RU: BTreeMap<usize, &'static str> = BTreeMap::from([
            ...
            (241, "Дата загрузки"),
            (242, "Дата создания"),
            (243, "* ключевое слово должно быть менее 100 символов"),
            ...
            (336, "Поддерживается язык разметки Markdown"),
            ...
            (340, "Максимальная длина комментария 500 символов"),
            (341, "Комментарий"),
            ...
            (434, "Файл"),
            (435, "Размер"),
            (436, "F: полный экран | 0-9: виды (5: орто/персп)"),
            (437, "Скрыть текстуры"),
            (438, "все"),
            (439, "до текущего"),
            (440, "только текущий"),
            ...
            (502, "Полусфера"),
            (503, "Ключевой свет"),
            (504, "Заполняющий свет"),
            (505, "Контражур"),
            (506, "Позиция ключевого света"),
            (507, "Позиция заполняющего света"),
            (508, "Позиция контрового света"),
            (509, "Интенсивности"),
            (510, "Позиции"),
        ]);
}
