...
lazy_static! {
    ...
    pub(super) static ref LOCAL_RU: BTreeMap<usize, &'static str> = BTreeMap::from([
            ...
            (401, "Набор файлов — это логическая группа файлов, привязанная к конкретной модификации компонента."),
            ...
            (407, "Модификация компонента — это отдельный вариант или версия компонента, фиксирующая конкретные параметры, материал, размеры, конфигурацию и другие особенности изделия."),
