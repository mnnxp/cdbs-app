...
lazy_static! {
    ...
    pub(super) static ref LOCAL_EN: BTreeMap<usize, &'static str> = BTreeMap::from([
            ...
            (241, "Upload at"),
            (242, "Created at"),
            (243, "* keywords must be less than 100 characters"),
            ...
            (334, "Edit"),
            (335, "Preview"),
            (336, "Markdown markup language is supported"),
            ...
            (340, "The maximum message length is 500 characters"),
            (341, "Message"),
            ...
            (401, "A file set (fileset) is a logical group of files linked to a specific component modification."),
            ...
            (407, "A component modification is an individual variant or version of a component that captures specific parameters, material, dimensions, configuration, and other product characteristics."),
            ...
            (434, "File"),
            (435, "Size"),
            (436, "F: fullscreen | 0-9: views (5: ortho/persp)"),
            (437, "Hide Textures"),
            (438, "all"),
            (439, "up to current"),
            (440, "current only"),
            ...
            (458, "Granted At"),
            (459, "Users Access"),
            (460, "Companies Access"),
            (461, "Actions"),
            (462, "Company Roles & Permissions"),
            (463, "New Role"),
            (464, "No Roles Yet"),
            (465, "Roles help you organize team members and control their access to company resources."),
            (466, "Create First Role For The Company"),
            (467, "Role Name"),
            (468, "Access Permissions"),
            (469, "No permissions"),
            (470, "Create Company Role"),
            (471, "Role"),
            (472, "Type to new role name..."),
            (473, "Edit Role"),
            (474, "Role ID:"),
            (475, "Select which permissions this role should have"),
            (476, "This role will have no permissions. Members with this role won't be able to do anything."),
            (477, "Company Members"),
            (478, "Add Member"),
            (479, "Manage team members can do access your company."),
            (480, "No members in this company."),
            (481, "Type to search users..."),
            (482, "Type to search companies..."),
            (483, "Joined At"),
            (484, "Add User"),
            (485, "Add User Access"),
            (486, "Search User"),
            (487, "Access Level"),
            (488, "Add Company Access"),
            (489, "Search Company"),
            (490, "Add Company Member"),
            (491, "Add Company"),
            (492, "No users found"),
            (493, "Found:"),
            (494, "Avatar"),
            (495, "No users have access to this component."),
