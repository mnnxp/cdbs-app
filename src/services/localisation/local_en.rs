...
lazy_static! {
    ...
    pub(super) static ref LOCAL_EN: BTreeMap<usize, &'static str> = BTreeMap::from([
            ...
            (255, "<p>CADBase is a digital platform enabling engineers and enthusiasts worldwide to browse, store, and share parts and engineering data effortlessly. Manufacturers can also publish catalogs of their products to distribute data to customers and disseminate product information to a wider audience.</p><p>We warmly welcome engineers, architects, designers, and enthusiasts who love to exchange ideas, concepts, and experiences. No matter where you are located, if you're passionate about learning and sharing knowledge, CADBase is here to support you.</p><p>Since 2018, our platform has grown and evolved through the valuable contributions of Ivan Nosovsky, Julia Gerasimova, Xia TianHao (夏添豪), and many others. Our mission is to cultivate a collaborative community that drives innovation and turns ideas into good things of engineering and design solutions.</p><p>We hope you enjoy using CADBase. Currently, we are actively seeking manufacturers interested in partnering with us and sharing valuable feedback to help us improve and grow together.</p>"),
            (256, "Overviews"),
            (257, "Version "),
