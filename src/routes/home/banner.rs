        ...
        html!{
            <div class="tile is-parent container">
                <div class="tile is-parent">
                    <div class="tile is-child box">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="19.0909" height="19.1045" rx="6" fill="#F3F6FF"/>
                            <rect y="20.8955" width="19.0909" height="19.1045" rx="6" fill="#F3F6FF"/>
                            <rect x="21.9082" y="1" width="17.0909" height="17.1045" rx="5" stroke="#1872F0" stroke-width="2"/>
                            <rect x="20.9082" y="20.8955" width="19.0909" height="19.1045" rx="6" fill="#F3F6FF"/>
                        </svg>
                ...
                <div class="tile is-parent">
                    <div class="tile is-child box">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
                            <rect fill="#F3F6FF" height="40" rx="5.991" width="40"/>
                            <text space="preserve" x="11.88" y="30.044" font-size="10.885" font-family="URW Gothic" fill="#1872F0">
                ...
                <div class="tile is-parent">
                    <div class="tile is-child box">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect y="5" width="40" height="30" rx="6" fill="#F3F6FF"/>
                            <rect width="40" height="2" rx="1" fill="#1872F0"/>
                            <rect x="12" y="19" width="16" height="2" rx="1" fill="#1872F0"/>
                            <rect x="21" y="12" width="16" height="2" rx="1" transform="rotate(90 21 12)" fill="#1872F0"/>
                            <rect y="38" width="40" height="2" rx="1" fill="#1872F0"/>
                        </svg>
                ...
                <div class="tile is-parent">
                    <div class="tile is-child box">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="40" height="40" rx="6" fill="#F3F6FF"/>
                            <path d="M24 6L30 12.5L24 19" stroke="#1872F0" stroke-width="1.7" stroke-linecap="round"/>
                            <path d="M16 34L10 27.5L16 21" stroke="#1872F0" stroke-width="1.7" stroke-linecap="round"/>
                            <path d="M36.5 27.5H10" stroke="#1872F0" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M3.5 12.5H30" stroke="#1872F0" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
