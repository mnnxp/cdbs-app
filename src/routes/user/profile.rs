    ...
    fn show_profile_action(&self) -> Html {
        let menu_arr: Vec<MenuItem> = vec![
            ...
            MenuItem {
                ...
                item_class: classes!("has-background-white"),
                icon_class: classes!("fas", "fa-puzzle-piece"),
            ...
            MenuItem {
                ...
                item_class: classes!("has-background-white"),
                icon_class: classes!("fas", "fa-building"),
            ...
            MenuItem {
                ...
                item_class: classes!("has-background-white"),
                icon_class: classes!("fas", "fa-user"),
