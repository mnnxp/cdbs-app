...
use crate::fragments::supplier_service::{SpecsTags, SpecTagItem};
use crate::types::{Spec, SpecPathInfo, UUID};
use crate::services::{LocaleKey, get_value_response, get_from_value};
    ...
    fn update(&mut self, msg: Self::Message) -> ShouldRender {
        ...
        match msg {
            Msg::ParseSpecs => {
                ...
                for spec in &self.props.service_specs {
            ...
            Msg::DeleteCurrentSpec(spec_id) => {
                ...
                for spec in self.props.service_specs.iter() {
                    if spec.spec_id == spec_id {
                ...
                self.props.service_specs = props_specs;
            },
            Msg::Ignore => {},
        }
        ...
        html!{<>
            ...
            <div class="panel-block">
                <SpecsTags
                    show_manage_btn={true}
                    service_uuid={self.props.service_uuid.clone()}
                    specs={self.props.service_specs.clone()}
