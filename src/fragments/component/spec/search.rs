    ...
    fn update(&mut self, msg: Self::Message) -> ShouldRender {
        ...
        match msg {
            Msg::ParseSpecs => {
                ...
                for spec in &self.props.component_specs {
            ...
            Msg::DeleteCurrentSpec(spec_id) => {
                ...
                for spec in self.props.component_specs.iter() {
                    if spec.spec_id == spec_id {
                ...
                self.props.component_specs = props_specs;
            },
            Msg::Ignore => {},
        }
        ...
        html!{<>
            ...
            <div class="panel-block">
                <SpecsTags
                    show_manage_btn = true
                    component_uuid = {self.props.component_uuid.clone()}
                    specs = {self.props.component_specs.clone()}
